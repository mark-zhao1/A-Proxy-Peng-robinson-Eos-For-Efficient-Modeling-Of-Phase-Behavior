'''
Generates training instances for each component in the mixture.
...
Previous dataset used numP=100 and num_x=10000
1E6 instances is around 100mb, so can actually use 1E7 instances.
Then numP=1E3 and num_x=1E4 can work
Save in new folder
'''
...
if __name__ == '__main__':
    # Where to store data
    filepath = r'C:\\Users\\markz\\OneDrive\\Documents\\Datasets\\Monahans_0302221\\'
    # Create suffix with date and name
